...
class Land_household(Agent):
    ...
    def yearly_activities(self):
        ...
        if self.debt > 0:
            ...
            self.debt = max(0, self.debt - self.yearly_loan_payment)
        ...
        if crop == "Shrimp":
            ...
            if self.disease == 1:
                ...
                if self.savings > self.expenditure / 2:
                    # You have enough  money and do not need the yield. You
                    # will not use antibiotics
                    self.use_antibiotics = 0
    ...
    def check_savings(self):
        ...
        self.yearly_income += self.total_hh_income
    ...
    def check_changes(self):
        ...
        if self.savings < 0 or self.farming_time_left == 0:
            ...
            # IF YOU CAN GET A LOAN FOR A YEAR, YOU WILL NOT MIGRATE
        ...
        # If your income is lower than your expenditure, something needs to
        # change.
    ...
    def prepare_livelihood(self):
        ...
        if self.model.education_level != 2:
            self.average_hh_education = self.model.education_level
